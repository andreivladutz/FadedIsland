...
<tileset version="1.2" tiledversion="1.2.3" name="head_soldier" tilewidth="32" tileheight="32" tilecount="24" columns="12">
 <image source="../tileset_images/head_soldier.png" width="400" height="64"/>
 <tile id="0">
  <animation>
